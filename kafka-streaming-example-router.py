...
@router.post("/user-events", response_model=EventResponse)
...
@router.post("/order-events", response_model=EventResponse)
...
@router.post("/product-analytics", response_model=EventResponse)
...
@router.post("/batch-events", response_model=Dict[str, Any])
...
@router.get("/topics/{topic}/recent-messages")
